    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        mResetImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getContext(), getContext().getString(R.string.custom_seekbar_jLib_default_value_to_set, getTextValue(mDefaultValue)),
            ...
            if (!mTrackingTouch || mContinuousUpdates) {
                if (mDefaultValueTextExists && mDefaultValueExists && mValue == mDefaultValue) {
                    mValueTextView.setText(mDefaultValueText + " (" +
                            getContext().getString(R.string.custom_seekbar_jLib_default_value) + ")");
                } else {
                    mValueTextView.setText(getContext().getString(R.string.custom_seekbar_jLib_value, getTextValue(mValue)) +
                ...
                if (mDefaultValueTextExists && mDefaultValueExists && mTrackingValue == mDefaultValue) {
                    ...
                    mValueTextView.setText(getContext().getString(R.string.custom_seekbar_jLib_value, "[" + getTextValue(mTrackingValue) + "]"));
                }
            }
        }
        if (mResetImageView != null) {
