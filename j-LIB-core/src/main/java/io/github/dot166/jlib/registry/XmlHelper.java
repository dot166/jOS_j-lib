...
public class XmlHelper {
    ...
    public static void writeXmlToFile(Context context, String fileName, List<RegistryHelper.Object> stations) {
        try {
            ...
            for (int i = 0; i < stations.size(); i++) {
                ...
                serializer.attribute("", "objectName", station.getName());
                serializer.attribute("", "objectUrl", station.getUrl());
                serializer.attribute("", "objectLogoUrl", station.getLogoUrl());
    ...
    public static List<RegistryHelper.Object> readXmlFromFile(Context context, String fileName) {
        return readXmlFromFile(context, fileName, null);
    }

    public static List<RegistryHelper.Object> readXmlFromFile(Context context, String fileName, Uri uri) {
        ...
        try {
            ...
            for (int i = 0; i < str_aar.length; i++) {
                ...
                String[] attrs = str_aar[i].replace("<object# ", "").replace("></object>", "").replace("# ", "#").split("#");
...
//                    break;
                case XmlPullParser.END_DOCUMENT:
                    return stringBuilder.toString().replace("<objects>", "").replace("<object></object>;", "").replace(";</objects>;", "");
