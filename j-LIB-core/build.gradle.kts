...
dependencies {
    ...
    api("androidx.compose.ui:ui-android:1.9.0")
    api("androidx.compose.material3:material3-android:1.3.2")
    api("androidx.compose.material:material-android:1.9.0")
...
configure<GenerateBpPluginExtension> {
    ...
    availableInAOSP.set { module: Module ->
        when {
            ...
            module.name == "savedstate-compose-android" -> false // aosp does not have it
	    module.name == "runtime-annotation-android" -> false // see above comment
